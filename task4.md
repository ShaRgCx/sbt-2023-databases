...
Да, возможно, исходя из данных с официального [сайта](https://prometheus.io/docs/prometheus/latest/storage/)

![image](https://user-images.githubusercontent.com/78553805/236840528-2a6a0ef3-1dd7-4cb3-9965-0ad369feb018.png)
...
Методы восстановления не поддерживаются, данные не реплицируются на другие ноды и не кластеризуются. Поэтому разработчики рекомендуют делать снапшоты текущих данных для возможности восстановлению ([подробнее](https://prometheus.io/docs/prometheus/latest/querying/api/#snapshot))
